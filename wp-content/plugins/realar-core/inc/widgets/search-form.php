...
class realar_search_form_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'realar_search_form_widget',

                // Widget name will appear in UI
                esc_html__( 'Realar :: Search Form', 'realar' ),

                // Widget description
                array(
                    'classname'                     => 'widget_search',
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Search Form Widget', 'realar' ),
                )
            );
        }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'placeholder' ); ?>"><?php _e( 'Search:' ,'realar'); ?></label>
    ...
    } // Class realar_search_form_widget ends here


    // Register and load the widget
    function realar_search_form_load_widget() {
        register_widget( 'realar_search_form_widget' );
    }
    add_action( 'widgets_init', 'realar_search_form_load_widget' );