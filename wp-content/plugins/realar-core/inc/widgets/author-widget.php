...
class realar_author_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'realar_author_widget',

                // Widget name will appear in UI
                esc_html__( 'Realar :: Author Widget', 'realar' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'realar' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function widget( $args, $instance ) {
			...
			<div class="author-widget-wrap">
                ...
                <div class="author-info">
                    <h4 class="name"><?php echo wp_kses_post( $about_name ); ?></h4>
                </div>
                <?php endif; ?>
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'realar'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'realar'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'realar'); ?></label>
    ...
    } // Class realar_author_widget ends here


    // Register and load the widget
    function realar_author_load_widget() {
        register_widget( 'realar_author_widget' );
    }
    add_action( 'widgets_init', 'realar_author_load_widget' );