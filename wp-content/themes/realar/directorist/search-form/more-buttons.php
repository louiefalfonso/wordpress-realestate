...
<div class="directorist-search-form-action">
	...
	<?php if ( $searchform->has_more_filters_button ): ?>
		...
		<div class="directorist-search-form-action__filter">
			<a href="#" class="directorist-btn directorist-btn-lg directorist-filter-btn th-btn">
	...
	<?php if ( $searchform->has_search_button ): ?>
		...
		<div class="directorist-search-form-action__submit">
			<button type="submit" class="directorist-btn directorist-btn-lg directorist-btn-dark directorist-btn-search th-btn">
