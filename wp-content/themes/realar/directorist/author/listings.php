...
<div class="directorist-author-listing-top directorist-flex directorist-justify-content-between">
	...
	<div>
		<h2 class="directorist-author-listing-top__title"><?php esc_html_e( 'Author Listings' , 'realar'); ?></h2>
	...
	<?php if ( $author->cat_filter_enabled() ): ?>
		...
		<div class="directorist-dropdown directorist-dropdown-js directorist-author-listing-top__dropdown directorist-dropdown-update-js">
			...
			<a class="directorist-dropdown__toggle directorist-dropdown__toggle-js directorist-toggle-has-icon directorist-btn directorist-btn-outline-primary" href="#" id="directorist-dropdown-menu-link"><?php esc_html_e( 'Filter by category', 'realar'); ?> <span class="atbd_drop-caret"></span></a>
