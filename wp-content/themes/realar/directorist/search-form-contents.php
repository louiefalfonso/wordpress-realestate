...
<div class="directorist-search-contents" data-atts='<?php echo esc_attr( $searchform->get_atts_data() ); ?>' style="<?php echo esc_attr( $searchform->background_img_style() ); ?>">
	...
	<div class="<?php Helper::directorist_container_fluid(); ?>">
		...
		<form action="<?php echo esc_url( ATBDP_Permalink::get_search_result_page_link() ); ?>" class="directorist-search-form property-search-form" data-atts="<?php echo esc_attr( $searchform->get_atts_data() ); ?>">
