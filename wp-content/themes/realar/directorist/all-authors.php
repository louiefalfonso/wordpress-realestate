		...
		<div class="directorist-authors">
			...
			<?php if( $authors->display_sorting() ): ?>
				...
				<div class="directorist-authors__nav">
					<ul>
						<li>
							<a href="#" class="directorist-alphabet ALL" data-nonce="<?php echo esc_attr( wp_create_nonce( 'directorist_author_sorting' ) ); ?>" data-alphabet="ALL"><?php esc_html_e( 'All', 'realar' ); ?></a>
						</li>
			...
			<div class="directorist-authors__cards">
				...
				<div class="directorist-row">
					...
					if( $authors->author_list() ):
						...
						<p><?php esc_html_e( 'No authors found', 'realar' ); ?></p>
