...
<div class="directorist-archive-items directorist-archive-grid-view">
	...
	<div class="<?php Helper::directorist_container_fluid(); ?>">
		...
		<?php if ( $listings->have_posts() ): ?>
			...
			<div class="<?php echo esc_attr($listings->has_masonry() ? 'directorist-masonry' : ''); ?> <?php echo esc_attr(Helper::directorist_row('')); ?>">
				...
				<?php foreach ( $listings->post_ids() as $listing_id ): ?>
					...
					<div class="<?php Helper::directorist_column( $listings->columns ); ?> directorist-all-listing-col"><!-- directorist-all-listing-col -->
						<div class="property-card2"><!-- directorist-all-listing-col -->
		...
		<?php else: ?>
			...
			<div class="directorist-archive-notfound"><?php esc_html_e( 'No listings found.', 'realar' ); ?></div>
