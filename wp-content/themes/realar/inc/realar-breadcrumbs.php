...
if ( ! function_exists( 'realar_breadcrumbs' ) ) {
    function realar_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'realar' )
        );
        $args    = apply_filters( 'realar_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','realar') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error Page', 'realar' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'realar_breadcrumbs_filter', $html );
        }
