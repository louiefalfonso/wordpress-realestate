...
// image default alt
if( !function_exists( 'realar_img_default_alt' ) ){
	function realar_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'realar_img_tag' ) ){
	function realar_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = realar_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'realar_anchor_tag' ) ){
	function realar_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'realar_heading_tag' ) ){
	function realar_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'realar_paragraph_tag' ) ){
	function realar_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'realar_span_tag' ) ){
	function realar_span_tag( array $args ){
